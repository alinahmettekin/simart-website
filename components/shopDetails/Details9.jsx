...
export default function Details9({ product }) {
  ...
  const maxQuantity = product.max_purchase_quantity && product.max_purchase_quantity > 0 
                    ...
                    <div className="countdown-wrap">
                      ...
                      <div className="tf-countdown style-1">
                        <div className="js-countdown">
                          {" "}
                          <CountdownComponent labels="Gün :,Saat :,Dakika :,Saniye" />
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="row">
                      <div className="col-xl-6 col-12">
                        <div className="tf-product-delivery">
                          ...
                          <p>
                            Teslimat süresi:{" "}
                            <span className="fw-7">3-6 gün</span>
                          </p>
                        </div>
                      </div>
                      <div className="col-xl-6 col-12">
                        <div className="tf-product-delivery mb-0">
                          ...
                          <p>
                            <span className="fw-7">2</span> yıl garanti ve <span className="fw-7">48</span> saatte Teknik Servis Garantisi
                          </p>
                        </div>
                      </div>
                    </div>

                    ...
                    <div className="swiper tf-sw-product-sell-1 wrap-sw-over">
                        ...
                        >
                            {displayProducts.map((product, index) => {
                                ...
                                const oldPrice = (product.discount_price && product.price) ? product.price : (product.oldPrice || null);
                                const imgSrc = product.cover_image?.url || product.image?.url || product.imgSrc || "/images/products/product-1.jpg";
                                const hoverImgSrc = product.image?.gallery?.[0]?.url || product.imgHoverSrc || imgSrc;
                                            ...
                                            <div className="card-product-wrapper">
                                                ...
                                                <div className="list-product-btn absolute-2">
                                                    ...
                                                    >
                                                        ...
                                                        <span className="tooltip">Hızlı Ekle</span>
                                                    </a>
                                                    <a
